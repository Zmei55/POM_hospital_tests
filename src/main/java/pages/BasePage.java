...
public class BasePage {
    ...
    public BasePage(WebDriver driver) {
        this.driver = driver;
        PageFactory.initElements(driver, this); // строит все страницы (new) / отвечает за инициализации страниц и эл-ов
    }
...
//    }
    ...
    // скрывает рекламу по id
    public void hideAd() {
        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("document.getElementById('...').style.dispay='none';");
    }
}
